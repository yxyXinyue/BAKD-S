...
class MobileNetV2(nn.Module):
    ...
    def load_pretrained_weights(self, pretrained_path):
        print(f"尝试加载权重，路径为: {pretrained_path}")
        if not os.path.exists(pretrained_path):
            print(f"错误：未找到预训练权重文件，路径为 {pretrained_path}。")
            return
        try:
...
# 使用示例
model = mobilenetv2()
pretrained_path = '/public/home/lz_yxy_2706/fenlei/sanfenlei_fg1/models/mobilenetv2_1.0-0c6065bc.pth'
